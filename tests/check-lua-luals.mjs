/**
 * LuaLS conformance check for the palette plugin sources.
 *
 ...
 *
 * - positive: `lua/palette/**` must diagnose cleanly, including the
 *   `require("palette.*")` module tree and `bitty.ui` overlay usage.
...
function main() {
  ...
  const temp = mkdtempSync(join(tmpdir(), "palette-luals-"));
  const problems = [];
  try {
