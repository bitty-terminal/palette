-- Entry point for Palette (bitty-terminal.palette).
--
...
bitty.commands.register({
  name = "bitty-terminal.palette:hello",
  description = "Print a greeting from Palette.",
  run = function()
    bitty.notify.show({
      title = "Palette",
      body = "Hello from bitty-terminal.palette.",
    })
  end,
})
