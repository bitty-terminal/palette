...
lua:
    bunx --bun luaparse@{{luaparse_pin}} --quiet --file lua/palette/init.lua
    bunx --bun luaparse@{{luaparse_pin}} --quiet --file lua/palette/filter.lua
    bunx --bun luaparse@{{luaparse_pin}} --quiet --file lua/palette/scene.lua
